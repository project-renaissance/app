...
function HomeScreen({ navigation }) {
  const classroomCodeSheet = useRef(null);
  const snapPoints = ['35%', '50%'];
  const openJoinClassroomSheet = () => classroomCodeSheet.current.present();
    ...
    <SafeAreaView className="w-full h-full bg-tiger-lighter">
      <ScrollView className="mt-4">
        ...
        >
          ...
          >
            <TouchableOpacity onPress={openJoinClassroomSheet}>
        ...
        <InabBottomSheet bottomSheetRef={classroomCodeSheet} snapPoint={snapPoints} startIndex={1}>
          <View>
            <InabText
              weight="700"
              size={20}
